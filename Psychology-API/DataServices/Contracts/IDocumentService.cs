...
namespace Psychology_API.DataServices.Contracts
{
    ...
    public interface IDocumentService : IBaseService
    {
        ...
        Task<IEnumerable<DocumentForReturnListDto>> SetInterdepartId(IEnumerable<Document> documents);
        Task<DocumentForReturnListDto> SetInterdepartId(Document document);
    }
}